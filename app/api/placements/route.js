...
function applyRuntimeCorrections(sourceCompanies) {
  ...
  upsert({ slug: "qualcomm-hw-2027", name: "Qualcomm", role: "Full-Time HW — 2027 Campus Drive", industry: "Semiconductors / Hardware Engineering / Embedded Systems", applicationStatus: "Need Info", appliedDate: "2026-08-26", currentStage: "Puneet was directly included in the Qualcomm registered-candidate email. The separate HirePro registration deadline passed at 8:00 AM on 27-Aug-2026, and completion is not independently verifiable. RVITM scheduling still lists Qualcomm OA today at 3:00 PM at RVCE.", nextAction: "If HirePro registration was completed, attend the Qualcomm OA at 3:00 PM today and monitor placement communication for the exact RVCE room/reporting point. If it was not completed, wait for official eligibility/attendance clarification rather than assuming the OA is active.", deadline: null, timeline: [{ stage: "HirePro registration deadline passed", date: "27 August 2026, 8:00 AM IST; completion unverified" }, { stage: "Online Assessment", date: "27 August 2026, 3:00 PM; RVCE room/reporting point TBD; conditional on completed HirePro registration" }], source: "Direct Qualcomm registered-candidate email dated 26-Aug-2026 plus newer RVITM scheduling WhatsApp dated 26-Aug-2026", notes: "Package and detailed JD remain unconfirmed. The user was on the registered-candidate distribution, but the separate HirePro completion cannot be verified from connected sources." });
...
function buildAnnouncements(companies) {
  ...
  const announcements = [];
  if (bySlug.get("qualcomm-hw-2027")?.applicationStatus === "Need Info") announcements.push({ id: "qualcomm-oa-2026-08-27", title: "Qualcomm OA today at 3:00 PM — registration completion unverified", message: "The 8:00 AM HirePro deadline has passed. Qualcomm OA remains scheduled for 27-Aug at 3:00 PM, but personal participation should be treated as active only if HirePro registration was completed or placement staff confirms eligibility. Exact RVCE room/reporting point is still TBD.", date: "2026-08-27", type: "warning" });
