...
const LATEST_COMPANIES = [
  ...
  },
  {
    ...
    timeline: [
      ...
      { stage: "Awaiting OA result / interview shortlist", date: "No result date announced yet" },
      { stage: "Campus interviews", date: "21 August 2026; only if shortlisted; exact time/venue TBD" },
    ],
    source: "Official IDFC / RVCE placement emails and Puneet Dixit's confirmation on 10 August 2026 that the OA was completed",
  },
  {
    slug: "gocomet",
    name: "GoComet",
