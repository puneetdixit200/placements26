...
export async function GET() {
  ...
  const data = {
    ...
    meta: {
      ...sourceData.meta,
      lastUpdated: "2026-08-09T19:50:00+05:30",
      rawDataThrough: "2026-08-09",
      notice: "Placement records are synced through 9 August 2026 from official placement communications and the primary placement tracker. Google and Flipkart remain hidden until a fresh official notice appears. Always verify the latest placement-cell message before acting.",
    },
    announcements: [
      {
        id: "placement-sync-2026-08-09-sharechat-registration",
        title: "ShareChat registration requires urgent confirmation",
        message: `${companies.length} active company records are shown. The 9 August 7:00 PM ShareChat registration deadline has passed, and the campus sheet still shows Puneet's Gender blank and Resume link as 'PUNEET'. Contact the placement cell or ShareChat campus coordinator immediately to confirm whether the registration can still be corrected or accepted.`,
        date: "2026-08-09",
        type: "warning",
      },
      ...olderAnnouncements,
