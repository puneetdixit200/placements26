...
const LATEST_COMPANIES = [
  ...
  },
  {
    ...
    description: "IDFC FIRST Bank is conducting a 2027 campus recruitment drive at RVCE for the Application Engineer role. Puneet Dixit is on the official OA shortlist and is allotted CCH LAB 1 & 2 at RVCE/RVU; candidates must assemble by 4:45 PM for the 10 August 5:00 PM assessment.",
    ...
    requirements: [
      ...
      "Officially shortlisted candidates must report to CCH LAB 1 & 2 at RVCE/RVU by 4:45 PM for the 10 August 2026, 5:00 PM OA with a fully charged/plugged-in laptop; off-campus attempts are not permitted",
      "HirePro login validity is 5:00–5:30 PM IST; test link: https://a.hirepro.in/3kKXwZ17; webcam/mic, latest stable Chrome and the secure assessment extension are mandatory",
    ],
    ...
    timeline: [
      ...
      { stage: "On-campus assessment", date: "10 August 2026, 5:00 PM at CCH LAB 1 & 2, RVCE/RVU; assemble by 4:45 PM; login validity 5:00–5:30 PM" },
      { stage: "Campus interviews", date: "21 August 2026; shortlist/time TBD" },
    ],
    source: "Official IDFC / RVCE placement emails, HirePro credentials and location sheet received 10 August 2026; Puneet Dixit is shortlisted and allotted CCH LAB 1 & 2",
  },
  {
    slug: "gocomet",
    name: "GoComet",
...
export async function GET() {
  ...
  const data = {
    ...
    meta: {
      ...sourceData.meta,
      lastUpdated: "2026-08-10T16:50:00+05:30",
    ...
    announcements: [
      {
        id: "placement-sync-2026-08-10-idfc-location",
        title: "IDFC OA location confirmed — CCH LAB 1 & 2 by 4:45 PM",
        message: `${companies.length} active company records are shown. Puneet Dixit is allotted CCH LAB 1 & 2 for today's IDFC OA and must assemble by 4:45 PM. The HirePro login window is 5:00–5:30 PM, and off-campus attempts are not permitted. Eurofins registration also closes at 5:00 PM, followed by the Evertz pre-placement session at 6:00 PM.`,
        date: "2026-08-10",
        type: "warning",
      },
      ...olderAnnouncements,
