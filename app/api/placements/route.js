...
function applyRuntimeCorrections(sourceCompanies) {
  ...
  upsert({ slug: "outbox", name: "OutBox", role: "Software Development Engineer – Intern", industry: "Full Stack Development / Software Engineering", package: { stipend: "₹30,000–₹40,000 per month" }, ppo: "₹10–12 LPA", applicationStatus: "Applied", appliedDate: "2026-08-25", currentStage: "Official RVITM registered-student list published 27-Aug-2026 confirms Puneet Dixit / 1RF23CS119 registered for OutBox. Mandatory SDE assignment is due Saturday, 29-Aug-2026; exact cutoff time is not stated.", nextAction: "Complete and submit the OutBox SDE assignment by 29-Aug-2026, ensure the work is your own, and verify the submission is shared/accessibly permissioned for the OutBox team.", deadline: "29 August 2026; exact cutoff time not stated", timeline: [{ stage: "Registration confirmed", date: "27 August 2026" }, { stage: "Mandatory SDE assignment deadline", date: "29 August 2026; exact cutoff time not stated" }], applicationUrl: "https://sumptuous-word-80f.notion.site/Software-Development-Intern-Assignment-2bc1596f45e88080995cec1180a2bc60", source: "Official RVITM registered-student list + assignment reminder dated 27-Aug-2026" });
  ...
  upsert({ slug: "qualcomm-hw-2027", name: "Qualcomm", role: "Full-Time HW — 2027 Campus Drive", industry: "Semiconductors / Hardware Engineering / Embedded Systems", applicationStatus: "Applied", appliedDate: "2026-08-26", currentStage: "Direct HirePro email on 27-Aug-2026 confirms Qualcomm Online Test credentials were issued to Puneet for the proctored remote OA scheduled at 3:00 PM. This supersedes the earlier uncertainty caused by the blank Resume Link field in the attached sheet. OA participation/completion is not independently verified after the test window.", nextAction: "Monitor Gmail/placement communication for the Qualcomm OA result or next-stage shortlist. Do not mark the OA completed unless direct evidence or user confirmation appears.", deadline: null, timeline: [{ stage: "Registered candidate / test credentials issued", date: "27 August 2026" }, { stage: "Remote proctored Online Assessment", date: "27 August 2026, 3:00 PM; participation unverified" }], source: "Direct HirePro Qualcomm Online Test Credentials email + official RVCE/RVITM updates", notes: "Receipt of direct Online Test Credentials is stronger evidence of personal OA eligibility than the earlier blank Resume Link field concern." });
  upsert({ slug: "baker-hughes", name: "Baker Hughes", role: "Digital Technology Intern", industry: "Digital Technology / Software / Engineering", package: { stipend: "₹50,000 per month" }, ppo: "₹12 LPA CTC/PBC", requirements: ["Minimum CGPA 7.5/10", "No current backlogs"], applicationUrl: "https://docs.google.com/spreadsheets/d/14Wu04_8bztxZWVofUWrGDqTTA75C_D4_8JryWayMNt8/edit?usp=sharing", applicationStatus: "Applying", currentStage: "New RVITM placement notice on 27-Aug-2026. Official Baker Hughes registration sheet already contains Puneet / 1RF23CS119 with CGPA 8.43, but Gender and Resume Link are blank. Registration deadline is 28-Aug-2026 at 9:00 AM.", nextAction: "Complete Gender and Resume Link in the Baker Hughes registration sheet before 28-Aug-2026 at 9:00 AM, then prepare for the full-day 2-Sep drive.", deadline: "28 August 2026, 9:00 AM IST", timeline: [{ stage: "Registration deadline", date: "28 August 2026, 9:00 AM IST" }, { stage: "Campus placement drive", date: "2 September 2026; full day" }], source: "RVITM Placement WhatsApp dated 27-Aug-2026 plus official registration sheet" });
...
function buildAnnouncements(companies) {
  ...
  if (bySlug.get("outbox")?.applicationStatus === "Applied") announcements.push({ id: "outbox-assignment-2026-08-29", title: "OutBox registration confirmed — assignment due 29 Aug", message: "RVITM's official registered-student list includes Puneet. Complete the mandatory SDE assignment by Saturday 29-Aug; exact cutoff time is not stated.", date: "2026-08-27", type: "warning" });
...
export async function GET() {
  ...
  return Response.json({
    ...
    meta: {
      ...
      notice: "Placement records combine the primary tracker with authoritative overrides and newer official updates. OutBox registration is confirmed and its mandatory SDE assignment is due 29-Aug. Qualcomm sent Puneet direct OA credentials for the 27-Aug 3:00 PM remote proctored assessment; participation/result remains unverified. Baker Hughes remains urgent: Puneet's row exists but Gender and Resume Link are blank, with registration due 28-Aug at 9:00 AM and a full-day drive on 2-Sep. GyanSys is newly announced but Puneet is Not Eligible because the published cutoff is 85% throughout and his official 12th score is 83. Walmart and Juspay are Applied with OAs on Friday 28-Aug, exact time/venue TBD. Cargill is Applied with the 31-Aug 2:00 PM test next if shortlisted. Qnance is Applied. TekoraAI is Need Info. IDFC is Not Selected; InMobi is Not Applicable; Sama is Not Applied; ShareChat/Eurofins are Not Shortlisted; Sartorius is Not Selected; AMD/Dover/Kinaxis/Coupa are Not Applied. Google and Flipkart remain excluded unless a fresh official notice appears.",
    },
