...
function applyRuntimeCorrections(sourceCompanies) {
  ...
  upsert({ slug: "juspay", name: "Juspay Technologies", role: "Software Development Engineer (SDE)", industry: "Payments Technology / Backend / Distributed Systems / Infrastructure", package: { stipend: "₹40,000 per month" }, ppo: "₹27 LPA CTC", applicationStatus: "Applied", appliedDate: "2026-08-23", currentStage: "Registration is confirmed and the mandatory Virtual PPT was held on 25-Aug-2026. A newer RVITM Placement WhatsApp update on 26-Aug postpones the campus hiring process from 27-Aug to Friday, 28-Aug-2026 because of multiple company clashes. Exact Friday reporting time and venue are still TBD.", nextAction: "Do not report for Juspay on 27-Aug. Monitor RVITM communication for the exact 28-Aug reporting time and venue; continue DSA, coding, CS-fundamentals, MCQ/OMR and hackathon preparation.", deadline: null, timeline: [{ stage: "Registration confirmed", date: "23 August 2026" }, { stage: "Virtual Pre-Placement Talk", date: "25 August 2026, 3:45 PM IST" }, { stage: "Campus Hiring Process", date: "Postponed to Friday, 28 August 2026; exact time/venue TBD" }], source: "Official RVITM Placement email plus newer WhatsApp dated 26-Aug-2026", notes: "The 26-Aug postponement supersedes the earlier 27-Aug 9:30 AM schedule." });
...
function buildAnnouncements(companies) {
  ...
  if (bySlug.get("juspay")?.applicationStatus === "Applied") announcements.push({ id: "juspay-postponed-2026-08-28", title: "Juspay postponed to Friday", message: "RVITM postponed the Juspay campus process from 27-Aug to Friday, 28-Aug because of company clashes. Exact time/venue are TBD.", date: "2026-08-26", type: "warning" });
...
export async function GET() {
  ...
  return Response.json({
    ...
    meta: {
      ...
      notice: "Placement records combine the primary tracker with authoritative overrides and newer official updates. Juspay is Applied but its campus process has been postponed from 27-Aug to Friday 28-Aug; exact time/venue TBD. Walmart is Applied with OA 27-Aug at RVCE, time TBD. Qualcomm HirePro registration remains due 27-Aug at 8:00 AM and the Qualcomm drive is 27-Aug with time TBD. Coupa closed 26-Aug without a completed Puneet registration. Cargill is Applied with the 31-Aug 2:00 PM test next if shortlisted. Qnance is Applied. IDFC is Not Selected; InMobi is Not Applicable; Sama is Not Applied; ShareChat/Eurofins are Not Shortlisted; Sartorius is Not Selected; AMD/Dover/Kinaxis/Coupa are Not Applied. Google and Flipkart remain excluded unless a fresh official notice appears.",
    },
