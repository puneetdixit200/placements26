...
const RUNTIME_LAST_UPDATED = "2026-08-25T20:58:00+05:30";
...
function applyRuntimeCorrections(sourceCompanies) {
  ...
  upsert({ slug: "walmart-global-tech", name: "Walmart Global Tech", role: "Full-Time + Internship — 2027 Campus Drive", industry: "Software Engineering / Global Technology / Enterprise Systems", package: { stipend: null }, ppo: "BE total compensation ₹26.09 LPA", description: "On-campus RVCE drive for Walmart Global Tech. The latest RVITM notice did not include a specific software-role JD or internship stipend.", requirements: ["2027 BE CSE cluster; ECE/Electrical roles also listed for relevant DSP/Image Processing/Computer Vision expertise", "7.0 CGPA & above", "No active backlogs", "Gender field is mandatory for shortlisting"], applicationUrl: "https://docs.google.com/spreadsheets/d/1hPD5PsSXTGmB7OVEWDlyPWVMzeSkncfV6UluZuaFPj0/edit?usp=sharing", applicationStatus: "Applying", currentStage: "Fresh RVITM placement update on 25-Aug-2026. Official Walmart registration sheet row 94 contains Puneet / 1RF23CS119 with CSE and 8.43 CGPA, but Gender and Resume Link are blank. Registration is incomplete.", nextAction: "Fill Gender and Resume Link in the official Walmart sheet before 26-Aug-2026 at 8:00 AM. Then prepare for the 27-Aug OA at RVCE.", deadline: "26 August 2026, 8:00 AM IST", timeline: [{ stage: "Registration deadline", date: "26 August 2026, 8:00 AM IST" }, { stage: "Online Assessment", date: "27 August 2026 at RVCE; time TBD" }, { stage: "Interviews", date: "1 September 2026 at RVCE; time TBD" }], skills: ["DSA", "Coding", "OOP", "DBMS/SQL", "Operating Systems", "Computer Networks", "Problem Solving"], source: "RVITM Placement WhatsApp dated 25-Aug-2026 plus official Walmart registration sheet", notes: "Gender is explicitly mandatory for shortlisting. Puneet's row is present but incomplete as of the evening recheck." });
...
function buildAnnouncements(companies) {
  ...
  const announcements = [];
  if (bySlug.get("walmart-global-tech")?.applicationStatus === "Applying") announcements.push({ id: "walmart-deadline-2026-08-26", title: "Walmart registration incomplete", message: "Walmart Global Tech registration closes 26-Aug at 8:00 AM. Gender and Resume Link are still blank in Puneet's official row.", date: "2026-08-25", type: "warning" });
